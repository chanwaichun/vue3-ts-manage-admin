...
<template>
	...
	<div class="card table-main">
		...
		<div class="table-header">
			...
			<slot :isSelected="isSelected" :selectedList="selectedList" :selectedListIds="selectedListIds" name="tableHeader" />
			<!-- </div> -->
			<!-- <div class="header-button-ri" v-if="showToolBar">
		...
		>
			...
			<template v-for="item in tableColumns" :key="item">
				...
				<el-table-column v-if="item.type == 'expand'" v-slot="scope" :align="item.align ?? 'center'" v-bind="item">
...
const { tableData, pageable, searchParam, searchInitParam, getTableList, search, reset, handleSizeChange, handleCurrentChange } =
	useTable(props.requestApi, props.initParam, props.pagination, props.dataCallback, tableRef, selectedList);

// 清空选中数据列表
const clearSelection = () => tableRef.value!.clearSelection();
const toggleRowSelection = (row: any, selected: any) => tableRef.value!.toggleRowSelection(row, selected);
// 初始化请求
